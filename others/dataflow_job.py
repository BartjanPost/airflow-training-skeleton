...
def run(argv=None):
    ...
    parser.add_argument(
        "--input",
        dest="input",
        default="gs://airflow_training_bp/land_registry_price_paid_uk/*/*.json",
    ...
    pipeline_args.extend(
        [
            ...
            "--staging_location=gs://airflow_training_bp/dataflow-staging",
            "--temp_location=gs://airflow_training_bp/dataflow-temp",
